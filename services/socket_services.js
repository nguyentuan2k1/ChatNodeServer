...
async function clientSendMessage(data) {
...
async function updateReadMessages(data) {
        const chatID = data["chatID"];
...
async function userTyping(data) {
        const chatID = data["chatID"];
...
async function userStopTyping(data) {
        const chatID = data["chatID"];
...
async function reconnectSocket(data) {
        let token           = data['access_token'];                                           
        const currentUserId = await helper.getCurrentUserIdByToken(token);
...
class SocketService {
        connection(socket) {
                ...
                socket.on("updateMessageStatus", async (data) => updateMessageStatus(data));
                socket.on("clientSendMessage", async (data) => clientSendMessage(data));
                socket.on("updateReadMessages", async (data) => updateReadMessages(data));
                socket.on("user-typing", async (data) => userTyping(data));
                socket.on("user-stop-typing", async (data) => userStopTyping(data));
                socket.on('disconnect', async (data) => logoutSocket(socket));
                socket.on('reconnect', async(data) => reconnectSocket(data));
        }
}

// At the bottom of the file, export the io instance
module.exports.io = _io; // Add this line
